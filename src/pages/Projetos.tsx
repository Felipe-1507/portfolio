...
// Tipos para as props do AnimatedElement
interface AnimatedElementProps {
  children: React.ReactNode;
  animation?: "fade" | "slideLeft" | "slideRight";
}

// Tipos para as props do ProjetoCard
...
const AnimatedElement: React.FC<AnimatedElementProps> = ({ children, animation = "fade" }) => {
...
const ProjetoCard: React.FC<ProjetoCardProps> = ({ titulo, descricao, imagem, tecnologias, link }) => {
  return (
          ...
          <AnimatedElement>
            <div className="card">
              ...
              <ol className="space-y-2 mb-6 list-decimal pl-5">
                <li>Edite o arquivo <code className="bg-[#222] px-2 py-1 rounded">src/pages/Projetos.tsx</code></li>
